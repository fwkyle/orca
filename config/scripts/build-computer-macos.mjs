...
const appPath = path.join(packagePath, '.build', 'release', 'Orca Kyle Computer Use.app')
...
<dict>
  ...
  <string>Orca Kyle Computer Use needs Accessibility permission to read and interact with app interfaces when you ask Orca Kyle to use apps.</string>
  <key>NSScreenCaptureUsageDescription</key>
  <string>Orca Kyle Computer Use needs Screen Recording permission to capture app windows when you ask Orca Kyle to inspect your screen.</string>
</dict>
</plist>
`
}
