...
export class OrchestrationDb {
  ...
  private migrate(): void {
    ...
    try {
      ...
      if (current < 25) {
        // Why: upstream placed this backfill inside v23, but the fork's v23/v24
        // migrations already ran on existing DBs before upstream's worker terminal
        // resource ownership landed. A separate, idempotent migration step ensures
